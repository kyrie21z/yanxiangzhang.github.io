...
# 相关算法:
[BFPRT - Median of Medians BFPRT选择算法](/blog/cs-major-courses/introduction-to-algorithms/bfprt---median-of-medians-bfprt选择算法/): 解决Quick Select在极端情况下的低效问题, 实现在任何情况下的线性时间解法
