...
|---|---|---|---|---|
| [计数排序](/blog/cs-major-courses/introduction-to-algorithms/counting-sort-计数排序/) | 统计每个离散键出现次数 | 小范围整数 | $\Theta(n+k)$ | 依赖键值范围大小 |
| [基数排序](/blog/cs-major-courses/introduction-to-algorithms/radix-sort-基数排序/) | 按位依次稳定排序 | 定长整数或字符串 | $\Theta(d(n+k))$ | 依赖位数与每位取值范围 |
